    ...
    <div className="min-h-screen bg-[#202020] flex items-center justify-center p-4">
      <div className="text-center space-y-6 md:space-y-8 max-w-lg mx-auto">
        ...
        <div className="pt-4 md:pt-6 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link 
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-white/10 text-white rounded-xl hover:bg-white/20 transition-all duration-300 font-semibold text-sm md:text-base hover:scale-105 active:scale-95"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
