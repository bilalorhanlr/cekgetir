          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              <a 
                ...
                className="bg-yellow-400 text-[#303030] px-4 lg:px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition-all duration-300 flex items-center gap-2 hover:scale-105 active:scale-95"
              >
              ...
              <a 
                ...
                className="bg-[#25D366] text-white px-4 lg:px-6 py-2 rounded-lg font-semibold hover:bg-[#1EA952] transition-all duration-300 flex items-center gap-2 hover:scale-105 active:scale-95"
              >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4 animate-fadeIn">
            ...
            <Link 
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <svg className="w-6 h-6 mr-1 text-[#303030]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              PNR Sorgula
            </Link>
            <div className="flex flex-col space-y-4 pt-4">
              <a 
                href="tel:+905404901000" 
                className="bg-yellow-400 text-[#303030] px-6 py-3 rounded-lg font-semibold hover:bg-yellow-500 transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#25D366] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#1EA952] transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
              >
