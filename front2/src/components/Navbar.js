      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link 
              href="/pnr-sorgula" 
              className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold rounded-xl shadow-lg hover:from-yellow-500 hover:to-yellow-400 focus:ring-2 focus:ring-yellow-400/60 transition-all duration-200 text-lg border-2 border-yellow-400 hover:scale-105 active:scale-95"
              style={{ boxShadow: '0 4px 24px 0 rgba(234, 179, 8, 0.15)' }}
            >
              <svg className="w-6 h-6 mr-1 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            href="/pnr-sorgula"
            className="md:hidden flex items-center gap-1 px-3 py-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold rounded-lg shadow-lg hover:from-yellow-500 hover:to-yellow-400 focus:ring-2 focus:ring-yellow-400/60 transition-all duration-200 text-base border-2 border-yellow-400 ml-2"
            style={{ boxShadow: '0 2px 12px 0 rgba(234, 179, 8, 0.15)' }}
          >
            <svg className="w-5 h-5 mr-1 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            PNR
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4">
            ...
            <Link 
              href="/pnr-sorgula" 
              className="block flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold rounded-xl shadow-lg hover:from-yellow-500 hover:to-yellow-400 focus:ring-2 focus:ring-yellow-400/60 transition-all duration-200 text-lg border-2 border-yellow-400 hover:scale-105 active:scale-95 text-center justify-center mt-2"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <svg className="w-6 h-6 mr-1 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
